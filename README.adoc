...
== Removing glue
Use Acetone applied to a Q-tip and gently work your way into the vinyl glue you plan on removing.
...
. https://vinylvibestudio.co/[Vinyl Vibe Studio], I don't recommend them due to being overpriced and for not selling DINP. If you need to be convinced that DINP is the best, get a bunch of Intex whales (modern ones are treated with DINCH) and treat them with each plasticizer separately and compare. Keep in mind that the longevity of alternatives to DINP is poor.
