...
. As vinyl glue is toxic before dying, handle it using polyethylene gloves. Avoid both nitrile and vinyl gloves as it'll stick to the glue, and avoid latex gloves as the MEK solvent in the vinyl glue will dissolve the latex.
...
=== The Procedure
. Purchase glue:
** Boxer Vinyl Adhesive #100 16oz / 1 pint. The best, but at a high price.
** https://www.loctiteproducts.com/en/products/specialty-products/specialty/loctite_vinyl_fabricplasticflexibleadhesive.html[Loctite Vinyl, Fabric & Plastic Adhesive]. An alternative to Boxer Vinyl Adhesive if you can't source it in your country.
** https://rhadhesives.com/product/hh-66-vinyl-cement-toluene-free-2[HH-66 Toluene Free Vinyl Cement]. Cheap in bulk; do not buy the variant containing Toluene.
...
** Polyethylene gloves: Get the ones considered as "food safe grade" / for food prep.
...
== Removing glue
Use Acetone applied to a lint-free microfiber cloth or a blunt-tip syringe and gently work your way into the vinyl glue you plan on removing.

Do not use Q-tips (cotton swabs), their cotton fibers will get stuck, which will ruin the finish of the vinyl. 
...
=== DINP or ATBC (and other non-phthalates)?
- DINP has greater elasticity, does not damage any types of paint, and reduces leaching from skin oils or sunlight. It also prevents vinyl paint cracking due to the greater elasticity. Its longevity is also a strong suit that non-phthalates lack.

=== Key Studies on DINP Health Effects (read in order)
The conclusion from these studies: DINP's risks are lower than other phthalates (e.g., DEP, DEHP); the main risk with phthalates however is if they're in aerosol form. DINP can be considered as non-harmful to humans for the inflatable treatment use case.
...
. Use polyethylene gloves during application.
...
. https://vinylvibestudio.co/[Vinyl Vibe Studio], I don't recommend them due to being overpriced and for not selling DINP. If you need to be convinced that DINP is the best, get a bunch of Intex whales (modern ones are treated with DINCH) and treat them with each plasticizer separately and compare. Keep in mind that the longevity of alternatives to DINP is poor except for TOTH (but TOTH is "stiff").
